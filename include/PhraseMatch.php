...
<?php
$exercicio = $_GET['idE'];
$stringE = "joao;;andre;;fernandes;;ana;;ribeiro";
$stringD = "fernandes;;ribeiro;;andre;;joao;;ana";
$instrucoes = "Ligue os nomes iguais";
$resposta = "joao---joao;;andre---andre;;ribeiro---ribeiro;;fernandes---fernandes;;ana---ana";
...
#DireitaButton{
    ...
    margin: 0px;
        ...
        <script type="text/javascript">
            var st = <?php echo json_encode($stringD) ?>;
            var str = <?php echo json_encode($stringE) ?>;
...
function getXValue(id) {
    ...
    if (sigla == "E") {
        return 150 + getLeftPosition(id);
    }
    else if (sigla == "D") {
        return getLeftPosition(id) - 150;
    }
    else {
        alert("Erro");
    }
...
function drawExitButton() {
    ...
    q.setAttribute('id', 'time');
   q.setAttribute('value', Math.floor((time / 1000) % 60));
    ...
    t.setAttribute('name', "id_exercicio");
    t.setAttribute('id', 'id_exercicio');
    t.setAttribute('value', idExercicio);
   
    f.appendChild(t);
    
    var o = document.createElement("input"); //input element, text
    o.setAttribute('type', "hidden");
    o.setAttribute('name', "idSessao");
    o.setAttribute('id', 'idSessao');
    o.setAttribute('value', idSessao);
    ...
    document.getElementById('all').appendChild(f);
        ...
        <meta charset="UTF-8">
        <title>Phrase Match Exercise</title>
    </head>
    <body onload="init(str, st, instrucoes, resposta, id, idSess)">
        <div id="all">
            <h1>Clique nas caixas que queira ligar: </h1>
            <h2 id="instrucoes"></h2>
            <div id="EsquerdaTab"></div>
            <div id="DireitaTab"></div>
            <div id="EsquerdaButton"></div>
            <div id="DireitaButton"></div>
        </div>
    </body>
</html>