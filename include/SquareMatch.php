...
<?php
$exercicio = $_GET['idE'];
$string = "joao;;andre;;ribeiro;;fernandes";
$instrucoes = "Coloque as peças no sítio original";
$imagens = "";
...
function drawExitButton() {
    ...
    y.setAttribute('name', "time");
    y.setAttribute('id', 'time');
    y.setAttribute('value', Math.floor((time / 1000) % 60));
 
    f.appendChild(y);

    var b = document.createElement("input"); //input element, text
    b.setAttribute('type', "hidden");
    b.setAttribute('name', "erradas");
    b.setAttribute('id', 'erradas');
    b.setAttribute('value', erradas);
  
    f.appendChild(b);

    var c = document.createElement("input"); //input element, text
    c.setAttribute('type', "hidden");
    c.setAttribute('name', "id_exercicio");
    c.setAttribute('id', 'id_exercicio');
    c.setAttribute('value', idExercicio);
...
function resize_images(maxht, maxwt, minht, minwt) {
    ...
    <body onload="init(str, instrucoes, imgs, id, idSess);">
        <div id="Exercicio" >
            <h1>Clique na caixa abaixo e no quadrado correspondente </h1>
            <h2 id="instrucoes"></h2>
            <div id="jogo">
