...
function drawExitButton() {
    ...
    document.getElementById('all').appendChild(f);
        ...
        <script type="text/javascript" src="PhraseMatch.js"></script>
        <link rel="stylesheet" type="text/css" href="PhraseMatch.css" title="default"/>
        <meta charset="UTF-8">
